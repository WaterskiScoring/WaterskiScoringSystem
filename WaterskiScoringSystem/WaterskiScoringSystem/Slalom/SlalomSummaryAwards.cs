...
namespace WaterskiScoringSystem.Slalom {
    public partial class SlalomSummaryAwards : Form {
        ...
        public SlalomSummaryAwards() {
            InitializeComponent();
        }

        private void SlalomSummaryAwards_Load(object sender, EventArgs e) {
        ...
        public void navRefresh_Click( object sender, EventArgs e ) {
            ...
            if ( mySanctionNum != null && myEvent != null ) {
                ...
                if (mySummaryDataTable.Rows.Count > 0) {
                    ...
                    } else {                        if (mySortCommand.Length > 1) {
            ...
            foreach ( DataRow curRow in curDataTable.Rows ) {
                ...
                if ( curEventClass.Length > 0 && curRound > 0 ) {
                    if ( h2hScoreButton.Checked || ( finalScoreButton.Checked && curNumPrelimRounds > 0 ) ) {
                        ...
                        curSkierPlcmt = getPlcmtNum( (String)curRow["PlcmtSlalom"] );
        ...
        private void SlalomSummaryAwards_FormClosed(object sender, FormClosedEventArgs e) {
        ...
        private void numAwardsTextBox_Validated(object sender, EventArgs e) {
            if (numAwardsTextBox.Text.Length > 0) {
                try {
                    ...
                    myTourProperties.SlalomSummaryAwardsNum = numAwardsTextBox.Text;
                } catch {
