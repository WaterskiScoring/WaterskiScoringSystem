...
namespace WaterskiScoringSystem.Slalom {
	public partial class ScoreEntry : Form {
		...
		private void addRecapRow() {
			Int16 curSkierPass, curMaxSpeedKph, curPassSpeedKph, curStartSpeedKph;
			...
			//String curListName = "SlalomPass" + ( Convert.ToInt16( curMaxSpeedKph ) ).ToString();
			//getPassData( curListName );
		...
		private void getApprovedTowboats() {
			int curIdx = 0;
			StringBuilder curSqlStmt = new StringBuilder( "" );
			curSqlStmt.Append( "SELECT Distinct ListCode, ListCodeNum, CodeValue, CodeDesc, SortSeq, Owner, Notes " );
			...
			curSqlStmt.Append( "SELECT ListCode, ListCodeNum, CodeValue, CodeDesc, SortSeq, '' as Owner, '' as Notes " );
