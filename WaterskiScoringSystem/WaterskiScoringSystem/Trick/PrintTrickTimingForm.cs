...
namespace WaterskiScoringSystem.Trick {
	class PrintTrickTimingForm {
		...
		public PrintTrickTimingForm() {
			myReportName = "PrintTrickTimingForm";
			myReportHeader = "PrintTrickTimingForm";
			myReportFooter = "";
			myTourRules = "";
			myTourName = "";
		...
		public bool Print( bool inShowPreview ) {
			String curMethodName = "PrintTrickSkierSpecForm:Print: ";
		...
		*/
		...
		private Single DrawHeader() {
			...
			Image curImageFile = global::WaterskiScoringSystem.Properties.Resources.TrickFormTiming;
			...
			if ( myShowHeader ) {
				...
				HelperPrintFunctions.PrintText( myGraphicControl, curText, curPosX, curPosY + 20, curTextBoxWidth, curTextBoxHeight, 0, 0, myReportHeaderFont, new SolidBrush( myReportHeaderTextColor ), TitleFormat );
			...
			curPosX = myLeftMargin;
			curPosY = myTopMargin + Convert.ToSingle( 75.0 );
