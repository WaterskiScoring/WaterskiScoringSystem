...
namespace WaterskiScoringSystem.Jump {
    public partial class JumpSummaryAwards : Form {
        ...
        public JumpSummaryAwards() {
            InitializeComponent();
        }

        private void JumpSummaryAwards_Load(object sender, EventArgs e) {
            ...
            foreach ( DataRow curRow in curDataTable.Rows ) {
                ...
                if ( curEventClass.Length > 0 && curRound > 0 ) {
                    if ( h2hScoreButton.Checked || ( finalScoreButton.Checked && curNumPrelimRounds > 0 ) ) {
                        ...
                        curSkierPlcmt = getPlcmtNum( ( String ) curRow["PlcmtJump"] );
        ...
        private void numAwardsTextBox_Validated(object sender, EventArgs e) {
            if (numAwardsTextBox.Text.Length > 0) {
                try {
                    ...
                    myTourProperties.JumpSummaryAwardsNum = numAwardsTextBox.Text;
                } catch {
