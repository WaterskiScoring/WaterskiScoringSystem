...
using WaterskiScoringSystem.SocketIoClientDotNet.Client;
using System;
using System.Collections.Generic;
using System.Threading;
using System.Threading.Tasks;
using Xunit;
using Socket = WaterskiScoringSystem.SocketIoClientDotNet.Client.Socket;
...
namespace SocketIoClientDotNet.Tests.ClientTests {
	...
	public class ServerConnectionTest : Connection {
		...
		public void ShouldReceiveUtf8MultibyteCharacters() {
			...
			options.Transports = ImmutableList.Create<string>( "polling" );
			//options.Transports = ImmutableList<string>() { "polling" };
			var uri = CreateUri();
			socket = IO.Socket( uri, options );
